# ==================================
# from https://github.com/TRHX/Python3-Spider-Practice/blob/master/SpiderDataVisualization/51job/get_51job_data.py
# --*-- coding: utf-8 --*--
# @Time    : 2020-07-11
# @Author  : TRHX
# @Blog    : www.itrhx.com
...
class JobSpider:
    ...
    def tatal_url(self):
        ...
        print("data " + response.content.decode('gbk'))
        print('tree ' + tree)
        # 提取一共有多少页
